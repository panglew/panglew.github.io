...
description: Summary & Project Descriptions for EECS491, Distributed Systems. Projects include MapReduce, Primary/Backup KV Store, Paxos Based KV Store, Sharded KV Store w/ Paxos Groups. Technologies used include Git, GitHub, Go.
---
...
### <span id="project-1">Project 1: <i>MapReduce</i></span>
